...
namespace EasyLog.Editor
{
    ...
    public class ManualTrackerEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                var newSaveLocation =
                    EditorUtility.OpenFolderPanel("Select Save Location", intervalTracker.saveLocation, "");
            ...
            for (int i = 0; i < intervalTracker.trackedPropertiesViaEditor.Count; i++)
            {
                ...
                if (selectedObject != null)
                {
                    ...
                    if ((intervalTracker.trackedPropertiesViaEditor[i].component)?.gameObject != selectedObject)
                    {
                        ...
                        intervalTracker.trackedPropertiesViaEditor[i].component =
                    ...
                    int currentComponentIndex = components.ToList()
                        .IndexOf(intervalTracker.trackedPropertiesViaEditor[i].component);
                ...
                if (intervalTracker.trackedPropertiesViaEditor[i].component != null)
                {
                    ...
                    int currentIndex =
                        propertiesAndFields.IndexOf(intervalTracker.trackedPropertiesViaEditor[i].propertyName);
